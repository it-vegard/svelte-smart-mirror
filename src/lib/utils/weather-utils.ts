...
export function mapWeatherSymbolToIcon(symbol: keyof typeof weatherSymbolKeys): string | undefined {
  return weatherSymbolKeys[symbol];
}

type WeatherSymbolKeyT = keyof typeof weatherSymbolKeys;

export type { WeatherSymbolKeyT };